...
import LevelThreeCategoryAb from "../../components/categoryPages/LevelThreeCategoryAb";
...
export async function getServerSideProps({ req, res, query }) {
  ...
  try {
    ...
    category = {
      ...
      products: [...response.data.productsRating],
    };
    ...
    category.products[0].product.descriptionBest =
    ...
    category.products[1].product.descriptionBest =
    ...
    category.products[2].product.descriptionBest =
    ...
    category.products[3].product.descriptionBest =
    ...
    category.products[4].product.descriptionBest =
    ...
    category.products[5].product.descriptionBest =
    ...
    category.products[6].product.descriptionBest =
