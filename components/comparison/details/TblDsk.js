      ...
      <table className={"table compare-tool"}>
        <thead>
          <tr>
            ...
            <th className={"headerth w25"} scope="col">
              <Typography className={"textSecondary"} fontSize={15}>
        ...
        <tbody>
          {pro1attr1 && pro2attr1 && (
            <tr>
              <td className={"py-4 px-5"} align="center">
                <Typography fontSize={25}>{pro1attr1}</Typography>
                <Stack>
                  <Rating
              ...
              <th className={"py-4 px-5"} align="center" scope="row">
                <Typography color={"#000"} fontSize={20} fontWeight={"bolder"}>
                  {comparison?.categoryId?.attributes[0]?.title}
                </Typography>
              </th>
              <td className={"py-4 px-5"} align="center">
                <Typography fontSize={25}> {pro2attr1}</Typography>
                <Stack>
                  <Rating
                    name="half-rating-read"
          ...
          {pro1attr2 && pro2attr2 && (
            <tr>
              <td className={"py-4 px-5"} align="center">
                <Typography fontSize={25}>{pro1attr2}</Typography>
                <Stack>
                  <Rating
                    name="half-rating-read"
                    defaultValue={
              ...
              <td className={"py-4 px-5"} align="center">
                <Typography fontSize={25}> {pro2attr2}</Typography>
                <Stack>
                  <Rating
                    name="half-rating-read"
                    defaultValue={
