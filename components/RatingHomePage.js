...
// components
import RatinglgHomePage from "./rating/RatinglgHomePage";
import Ratingxs from "./rating/Ratingxs";

function RatingHomePage(props) {
        ...
        <Box className={"w-100 m-0"}>
          ...
          >
            ...
            <Grid lg={8} xs={12} className={"shorDesGrid textCenter mx-auto"}>
              ...
              >
                A rating, whether given by a critic or a customer, is one of the
                most significant ways to realize a product’s potential. Here at
                Brandsreviews, we have also shown the ratings of each and every
                product, so you could understand the feedback given for a
                particular product, and gain a more clear understanding of them.
              </Typography>
            </Grid>
          </Grid>
          {/* start desktop */}
